...
\n
To ensure our models are not making false positive predictions, we will use the log loss function to measure the loss of each model. This is done by summing the predicted probability of a true positive divided by the number of predictors.\n         
